...
def main(args):
    ...
    output_video_path = save_dir + '.mp4'
    shutil.move(result, output_video_path)
    print('The generated video is named:', output_video_path)

    # ✅ Save a static version for frontend
    static_output_path = os.path.join(args.result_dir, 'result.mp4')
    shutil.copy(output_video_path, static_output_path)
    print('Static result video saved to:', static_output_path)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--batch_size", type=int, default=2, help="the batch size of facerender")
    parser.add_argument("--size", type=int, default=256, help="the image size of the facerender")
    parser.add_argument("--expression_scale", type=float, default=1., help="expression scale of output")
    parser.add_argument('--input_yaw', nargs='+', type=int, default=None, help="the input yaw degree of the user")
    parser.add_argument('--input_pitch', nargs='+', type=int, default=None, help="the input pitch degree of the user")
    parser.add_argument('--input_roll', nargs='+', type=int, default=None, help="the input roll degree of the user")
    parser.add_argument('--enhancer', type=str, default=None, help="Face enhancer, [gfpgan, RestoreFormer]")
